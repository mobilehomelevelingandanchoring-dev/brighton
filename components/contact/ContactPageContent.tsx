    ...
    <div className="space-y-12">
      <FadeIn>
        <h1 className="text-4xl sm:text-5xl font-bold text-[#f0f9ff] mb-4">
          Contact &amp; Find
          <span className="block gradient-text">Car Detailing in Brighton</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <FadeIn delay={150} className="space-y-4">
          <div className="bg-[#0f1624] border border-[#1e3a5f] rounded-2xl p-5">
            ...
            <a href="tel:+447495885042" className="text-2xl font-bold text-[#38bdf8] hover:text-white transition-colors font-mono block">
              +44 7495 885042
            </a>
