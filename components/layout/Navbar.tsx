          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <div className="hidden sm:block">
                <div className="text-sm font-bold text-[#f0f9ff] leading-tight">Car Detailing</div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden md:inline">+44 7495 885042</span>
          ...
          >
            ...
            <div className="absolute right-0 top-0 bottom-0 w-72 bg-[#0f1624] border-l border-[#1e3a5f] shadow-2xl flex flex-col">
              <div className="flex items-center justify-between p-6 border-b border-[#1e3a5f]">
                <div>
                  <div className="font-bold text-[#f0f9ff]">Car Detailing</div>
                  <div className="text-sm text-[#38bdf8]">in Brighton</div>
                </div>
                <button
                  onClick={() => setMobileOpen(false)}
